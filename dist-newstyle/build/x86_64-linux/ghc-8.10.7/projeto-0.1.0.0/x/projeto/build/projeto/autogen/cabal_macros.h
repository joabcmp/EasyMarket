...
/* package projeto-0.1.0.0 */
#ifndef VERSION_projeto
#define VERSION_projeto "0.1.0.0"
#endif /* VERSION_projeto */
#ifndef MIN_VERSION_projeto
#define MIN_VERSION_projeto(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projeto */
...
#define CURRENT_COMPONENT_ID "projeto-0.1.0.0-inplace-projeto"
